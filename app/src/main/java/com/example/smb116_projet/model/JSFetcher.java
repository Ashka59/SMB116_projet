...
public class JSFetcher extends AsyncTask<String, Void, Void> {
                ...
                for (int j = 0; j < steps.length(); j++) {
                    ...
                    if (start > flag) {
                        ...
                        locationlist.add(Feature.fromGeometry(
                                Point.fromLngLat(location1.getDouble(0), location1.getDouble(1))));
    ...
    public void propertyadder(List<Feature> asd, int i) { asd.get(i).addStringProperty("name", "WeatherObject" + i); }
